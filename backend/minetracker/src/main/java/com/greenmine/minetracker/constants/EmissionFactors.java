...
//Forest Survey of India (FSI) reports used for sequestration rate
...
public class EmissionFactors {
  ...
  public static final double FOREST_SEQUESTRATION_RATE_PER_HA = 3.5; // metric tons CO2 per hectare per year
}
